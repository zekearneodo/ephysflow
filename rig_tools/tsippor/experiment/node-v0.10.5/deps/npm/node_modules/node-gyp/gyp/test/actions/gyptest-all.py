...
# Some gyp structure use an action that mentions an output but never
...
# Clean out structure which may have been created if test.ALL was run.
def clean_dep_files():
...
# Try again with a target that has deps in reverse.  Output structure from
