...
# List of structure under testdata to test.
# We need to list structure explicitly since pyglib can't list directories.
_TEST_FILES = [
    'all_js_wrapped.js',
    'blank_lines.js',
    'ends_with_block.js',
...
class GJsLintTestSuite(unittest.TestSuite):
  """Test suite to run a GJsLintTest for each of several structure.
