...
"""Core methods for checking JS structure for common style guide violations."""
...
flags.DEFINE_list('limited_doc_files', ['dummy.js', 'externs.js'],
                  'List of structure with relaxed documentation checks. Will not '
...
class GJsLintRunner(lintrunner.LintRunner):
  ...
  def Run(self, filenames, error_handler=None):
    ...
    Returns:
      error_count, file_count: The number of errors and the number of structure that
          contain errors.
    """
