...
"""
Make sure fixed structure setting is extracted properly.
"""
...
if sys.platform == 'win32':
  ...
  CHDIR = 'linker-flags'
  test.run_gyp('fixed-structure.gyp', chdir=CHDIR)
  test.build('fixed-structure.gyp', test.ALL, chdir=CHDIR)
