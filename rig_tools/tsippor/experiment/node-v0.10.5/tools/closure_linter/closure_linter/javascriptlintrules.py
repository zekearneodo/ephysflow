...
"""Methods for checking JS structure for common style guide violations.
...
class JavaScriptLintRules(ecmalintrules.EcmaScriptLintRules):
  ...
  def CheckToken(self, token, state):
    ...
    # Call the structure class's CheckToken function.
  ...
  def Finalize(self, state, tokenizer_mode):
    ...
    # Call the structure class's Finalize function.
