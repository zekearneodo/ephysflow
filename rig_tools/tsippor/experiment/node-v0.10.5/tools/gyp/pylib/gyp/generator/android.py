...
# variables in .mk-structure clobber one another, and furthermore that any
...
android_standard_include_paths = set([
    ...
    'frameworks/structure/include',
    'frameworks/structure/opengl/include',
    'frameworks/structure/native/include',
...
class AndroidMkWriter(object):
  ...
  def Write(self, qualified_target, relative_target, base_path, output_filename,
    ...
    # List structure this target depends on so that actions/rules/copies/sources
    ...
    # on both our dependency targets and our generated structure.
    self.WriteLn('# Make sure our deps and generated structure are built first.')
  ...
  def WriteCopies(self, copies, extra_outputs):
    ...
    for copy in copies:
      for path in copy['structure']:
        # The Android build system does not allow generation of structure into the
  ...
  def WriteSourceFlags(self, spec, configs):
    """Write out the flags and include paths used to compile source structure for
    the current target.
    ...
    self.WriteLn('\n# Flags passed to both C and C++ structure.')
    ...
    self.WriteLn('\n# Flags passed to only C++ (and not C) structure.')
  ...
  def WriteSources(self, spec, configs, extra_sources):
    ...
    We need to handle shared_intermediate directory source structure as
    ...
    # into LOCAL_GENERATED_SOURCES. We also need to move over any C++ structure
  ...
  def NormalizeLdFlags(self, ld_flags):
    ...
    Args:
      ld_flags: ldflags from gyp structure.
