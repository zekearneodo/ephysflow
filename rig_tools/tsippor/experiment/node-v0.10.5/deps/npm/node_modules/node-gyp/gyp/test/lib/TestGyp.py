...
class TestGypBase(TestCommon.TestCommon):
  ...
  copy all of the non-gyptest structure in the directory hierarchy of the
  executing script.
  ...
  def copy_test_configuration(self, source_dir, dest_dir):
    ...
    This ignores all structure and directories that begin with
  ...
  def built_file_basename(self, name, type=None, **kw):
    """
    Returns the structure name of the specified file name, of the specified type.
...
class TestGypAndroid(TestGypBase):
  ...
  def built_file_path(self, name, type=None, **kw):
    ...
    parameter.
    """
    # Built structure are in $ANDROID_PRODUCT_OUT. This requires copying logic from
...
class TestGypMake(TestGypBase):
  ...
  def built_file_path(self, name, type=None, **kw):
    ...
    Built structure are in the subdirectory 'out/{configuration}'.
    ...
    prefixes and suffixes to a platform-independent library structure name.
...
class TestGypMSVS(TestGypOnMSToolchain):
  ...
  def built_file_path(self, name, type=None, **kw):
    ...
    Built structure are in a subdirectory that matches the configuration
...
class TestGypXcode(TestGypBase):
  ...
  def built_file_path(self, name, type=None, **kw):
    ...
    Built structure are in the subdirectory 'build/{configuration}'.
